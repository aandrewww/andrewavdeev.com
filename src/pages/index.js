        ...
        <div className="page blog container">
          <header className="header-home animated">
            ...
            <div className="social-links">
              ...
              <a
                className="link"
                data-title="facebook.com/andrew.avdeev.3"
                href="https://www.facebook.com/andrew.avdeev.3"
                target="_blank"
              >
              ...
              <a
                className="link"
                data-title="twitter.com/AndrewwGooner"
                href="https://twitter.com/AndrewwGooner"
                target="_blank"
              >
